...
public class Battle {
	...
	Player enemy;
	long[] lastActTime;//массив времени последних запросов игроков. Соответствует массиву игроков 
	...
	long lrt;
	ServBattleInfo sbi;
	public Battle(int id,Server server,Player[]players)
	{
		this.id=id;
		this.server=server;
    ...
    public void PlayerAct(PlayerActions acts)
    {
